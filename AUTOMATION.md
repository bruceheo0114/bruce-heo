...
- 한 번에 여러 글이 발견되면 콘텐츠 패키지는 오래된 글부터 만들고 LinkedIn은 하루 한 편씩 18:30(KST)에 처리합니다.
...
- 승인 시간이 예정 시각보다 늦으면 LinkedIn은 병합 후 처음 도래하는 18:30 실행에서 게시됩니다.
...
- GitHub 예약 실행은 UTC 기준입니다. `0 23 * * *`는 매일 08:00 KST, `30 9 * * *`는 매일 18:30 KST입니다.
